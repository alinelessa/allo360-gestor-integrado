...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "app-primary-btn px-4 py-2 text-sm font-semibold shadow-none",
        destructive:
          "rounded-xl bg-destructive px-4 py-2 text-destructive-foreground hover:opacity-90",
        outline:
          "rounded-xl border border-border/30 bg-transparent px-4 py-2 text-foreground hover:bg-secondary",
        secondary:
          "app-secondary-btn px-4 py-2 text-sm font-medium",
        ghost:
          "app-ghost-btn px-4 py-2 text-sm font-medium",
        link:
